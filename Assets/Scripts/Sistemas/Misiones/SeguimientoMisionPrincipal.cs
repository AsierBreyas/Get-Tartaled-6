...
public class SeguimientoMisionPrincipal : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        seguimiento.Add(new Mision("Llevale las sobras a amoña y preguntarle por Zaloa", "Entregale la lechuga y el huevo a amoña", "P-003"));
        seguimiento.Add(new Mision("Busca a Zaloa", "Explora el pueblo en busca de Zaloa", "P-004"));
        ...
        seguimiento.Add(new Mision("Busca al Basajaun", "Adentrate en el bosque para encontrar al hombre de los bosques", "P-007"));
        seguimiento.Add(new Mision("Extingue el fuego", "Apaga el fuego de los alrededores del bosque", "P-008"));
        seguimiento.Add(new Mision("Vuelve con Basajaun", "Has terminado con el recado, ya debería tener una respuesta", "P-009"));
        seguimiento.Add(new Mision("Ve a la cima del monte Itzal", "Es hora de pedirle explicaciones a tu hermano", "P-010"));
